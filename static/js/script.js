...
async function fetchMarketData() {
  const response = await fetch("/static/json/markets.json");
...
function checkMessage() {
  ...
  if (message == "Registration Error") {
    ...
    alert(
      "Please check your phone. This might take a few minutes. If you do not receive a link, please try again later."
    );
